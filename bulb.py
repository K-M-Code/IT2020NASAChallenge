...
async def main():
    ...
    bulbs = await discovery.discover_lights(broadcast_space="192.168.0.254")
    # Print the IP address of the bulb on index 0
    print("Bulb IP address: {bulbs[0].ip}")
    ...
    for bulb in bulbs:
        ...
        # await bulb.turn_off()
        # # Turn on all available bulbs
        # await bulb.turn_on()

    # # Set up a standard light
    # light = wizlight("", +str(bulbs[0].ip))
